...
window.onload = function() {
    ...
    function render() {
        ...
        if (gamestate == gamestates.gameover) {
            ...
            drawCenterText(` you Scored ${scorefinal}`, level.x, level.y + level.height / 2 + 70, level.width);
        }
    }
    ...
    function drawFrame() {
        ...
        context.fillText("Multitv", 10, 37);
